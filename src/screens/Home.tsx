...
export default function Home({ setScreen }: Props) {
    return (
            <div className="flex flex-col h-screen w-screen gap-9 max-lg:gap-6 items-center justify-center size-full bg-[#495DF8] text-black text-6xl max-lg:text-sm font-Jaro">
